...
var Program = Class(neuron.Program, {
    constructor: function () {
        ...
        ['entity', 'blob'].forEach(function (name) {
            ...
            var engine = Plugins.instance.connect(this, 'evo-cubes:engine.' + name, {
                name: engineConf.name,
                data: { conf: engineConf, logger: this.logger }
            });
            if (!engine) {
                throw new Error('Engine not available for ' + name);
            }
        ...
        this
            ...
            .dispatch('entity.update', { schema: { type: 'string', id: 'string', rev: 'string', data: { nullable: 'object' } } })
    ...
    'neuron:entity.update': function (req, params) {
        this.entityStore.update(params.type, params.id, params.rev, params.data, req.done);
    },
